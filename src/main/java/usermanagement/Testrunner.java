...
public class Testrunner {
    ...
    public static void main(String[] args) throws InterruptedException {
     ...
     // Calling the method for 'GradeT' workflow
		 ...
		 master.sectionDesignation(driver); 
		 rolemanagement.rolemaster(driver);
		 rolemanagement.userole(driver); 
		  rolemanagement.createuser(driver);
		 appmodule.moduleform(driver);
		  workflowprocess.workflowprocess1(driver);
